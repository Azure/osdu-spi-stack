...
The only tool you need is [`uv`](https://docs.astral.sh/uv/); it manages Python,
dependencies, and every command below.
...
- **No stored credentials.** All Azure PaaS access uses Workload Identity; never
