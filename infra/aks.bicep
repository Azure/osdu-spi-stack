...
@description('Availability zones for the system pool; the CLI supplies the subscription-resolved usable set, and the default serves direct template deploys only.')
