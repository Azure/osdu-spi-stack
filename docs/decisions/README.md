...
| [008](008-bicep-for-azure-provisioning.md) | Bicep for Azure Provisioning | Azure resources are declared in hand-written Bicep at pinned API versions; the CLI orchestrates only the seams Bicep cannot cover. |
