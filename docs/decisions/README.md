...
| [008](008-bicep-for-azure-provisioning.md) | Bicep for Azure Provisioning | Azure resources are declared in hand-written Bicep at pinned API versions; the CLI owns only the lifecycle seams: resource group, deployer cluster-admin grant, kubeconfig, CNI chaining, runtime secrets. |
